...
public class RabbitMQTestQueueListener implements MessageListener {
    private final static Logger logger = Logger.getLogger(RabbitMQTestQueueListener.class);
    public static boolean deleteMessage = true;

    @Override
    public void onMessage(Message message) {
        logger.info("Recibido message de la cola de Test para Listener1: " + new String(message.getBody()));
